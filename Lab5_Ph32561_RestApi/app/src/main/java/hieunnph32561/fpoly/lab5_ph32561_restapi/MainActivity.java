package hieunnph32561.fpoly.lab5_ph32561_restapi;
...
import hieunnph32561.fpoly.lab5_ph32561_restapi.adapter.DistributorAdapter;
import hieunnph32561.fpoly.lab5_ph32561_restapi.databinding.ActivityMainBinding;
import hieunnph32561.fpoly.lab5_ph32561_restapi.databinding.DialogAddBinding;
...
//        });
    ...
    private void showDialogAdd() {
        ...
        binding1.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Nhap name", Toast.LENGTH_SHORT).show();
                } else {
        ...
        binding1.btnCanner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                alertDialog.dismiss();
            }
    ...
    public void delete(Distributor distributor) {
        ...
        builder.setMessage("Bạn có muốn xóa k ?");
